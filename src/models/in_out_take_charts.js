...
module.exports = (sequelize, DataTypes) => {
    const in_out_take_charts = sequelize.define(
        "in_out_take_charts",
        {
            uuid: {
    ...
    in_out_take_charts.associate =  models => {
        in_out_take_charts.belongsTo(models.critical_care_charts , {
            foreignKey:"cc_chart_uuid",
            as:'critical_care_charts'
        });
        in_out_take_charts.belongsTo(models.critical_care_concepts , {
            foreignKey:"cc_concept_uuid",
            as:'critical_care_concepts'
        });
        in_out_take_charts.belongsTo(models.critical_care_concept_values , {
            foreignKey:"cc_concept_value_uuid",
            as:'critical_care_concept_values'
        });
    };

    return in_out_take_charts;
};