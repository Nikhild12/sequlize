...
const allergyTypeController = () => {
    ...
    const getAllergyType = async (req, res, next) => {
        ...
        try {
            await allergyTypeTbl.findAndCountAll(findQuery)
    ...
    return {
        ...
        getAllergyType,
        getallergyTypeById,
        deleteAllergyTypeById,
        updateAllergyTypeById

    };
};


module.exports = allergyTypeController();