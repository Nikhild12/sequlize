...
async function patientSurgeryHistory(patient_uuid) {
  return vw_surgical_details.findAll({
    ...
    where: { ps_patient_uuid: patient_uuid, ps_is_active: 1, ps_status: 1, ps_is_active: 1, ps_status: 1, institution_is_active: 1, institution_status: 1 }
